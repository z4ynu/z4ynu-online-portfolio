...
const Hero = () => {
  ...
  return (
    ...
    >
            ...
            <div className="space-y-4">
              ...
              <div className="border border-border/50 rounded-lg p-4 bg-card/20 backdrop-blur-sm text-center">
                <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
                  ...
                  and Minecraft. I also draw inspiration from a wide variety of
                  music that fuels both my work and hobbies.
                </p>
              </div>
            </div>
      ...
      {/* Scroll indicator */}
      <div
        className={`flex justify-center pb-8 transition-all duration-1000 ease-out delay-600 ${
          isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
        }`}
      >
        <button
