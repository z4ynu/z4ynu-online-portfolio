        ...
        <div className="max-w-6xl mx-auto px-6 md:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h1 className="text-4xl md:text-6xl font-bold text-balance">Zy Henzo S. Nuñez</h1>
              <div className="text-lg md:text-xl text-muted-foreground">Computer Science Student</div>
              <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
                I build accessible, pixel-perfect digital experiences for the web, craft compelling written content, and
                share the joy of music through tutoring.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button onClick={() => scrollToSection("contact")} className="text-base px-6 py-3">
                Get In Touch
              </Button>
              <Button variant="outline" onClick={() => scrollToSection("projects")} className="text-base px-6 py-3">
                View My Work
              </Button>
            </div>
            ...
            <div className="flex items-center space-x-6 pt-4">
              ...
              <a href="mailto:contact@z4ynu.dev" className="text-muted-foreground hover:text-primary transition-colors">
            ...
            <div className="relative">
              <div className="w-80 h-80 rounded-full bg-gradient-to-br from-primary/20 to-accent/20 flex items-center justify-center">
                <div className="w-64 h-64 rounded-full bg-card border border-border flex items-center justify-center">
                  <div className="text-6xl font-bold text-primary">ZN</div>
                </div>
              </div>
              {/* Floating elements */}
